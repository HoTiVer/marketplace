...
public class ProductController {
    ...
    public ResponseEntity<List<SellerInventoryProductDto>> getCurrentSellerProducts(
            Authentication auth) {
    ...
    @PreAuthorize("hasRole('SELLER')")
    @GetMapping("/seller/products/{productId}/price-history")
    public ResponseEntity<List<ProductPriceHistoryResponse>> getProductPriceHistory(
            @PathVariable Long productId) {
        return ResponseEntity.ok()
                .body(productPriceHistoryService.getProductPriceHistory(productId));
    }
